 ...
 *  under the License.
 */
package org.incode.eurocommercial.relatio.dom.child;
...
import org.incode.eurocommercial.relatio.dom.childcare.ChildCareRepository;
...
@Queries({
        @Query(
                ...
                value = "SELECT "
                        + "FROM org.incode.eurocommercial.relatio.dom.child.Child "
                        + "WHERE parent == :parent "),
        @Query(
