 ...
 *  under the License.
 */
package org.incode.eurocommercial.relatio.dom.user;
...
import org.incode.eurocommercial.relatio.dom.Gender;
...
import org.incode.eurocommercial.relatio.dom.child.ChildRepository;
import org.incode.eurocommercial.relatio.dom.mail.MailService;
...
@Queries({
        @Query(
                ...
                value = "SELECT "
                        + "FROM org.incode.eurocommercial.relatio.dom.user.User "
                        + "WHERE email == :email "
                        + "&& center == :center"),
        @Query(
