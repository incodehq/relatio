...
import org.incode.eurocommercial.relatio.dom.game.CardGame;
import org.incode.eurocommercial.relatio.dom.game.CardGameRepository;
...
@Queries({
        @Query(
                ...
                value = "SELECT "
                        + "FROM org.incode.eurocommercial.relatio.dom.card.Card "
                        + "WHERE number == :number "),
        @Query(
